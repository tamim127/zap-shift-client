      ...
      <div className="w-full max-w-md">
        <div className="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
          <div className="bg-white border-b border-gray-100 px-8 py-10 text-center">
            ...
            <p className="text-gray-600 mt-2">Login to your ZapShift account</p>
          </div>
          {/* Form Body */}
          ...
          focus:ring-opacity-20 focus:border-indigo-500 transition pr-12"
            ...
            {/* Google Login */}
            <button className="w-full border border-gray-300 text-gray-700 font-medium py-3.5 rounded-xl hover:bg-gray-50 transition flex items-center justify-center gap-3">
